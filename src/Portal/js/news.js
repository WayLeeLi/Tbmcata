...
function renderNewsList(items) {
    ...
    if (featured) {
        ...
        html += '<div class="news-featured-tag">' + (featured.CategoryName || '') + '</div>';
        html += '<div class="news-featured-date">' + (featured.Date || '') + '</div>';
        html += '<p class="news-featured-text">' + (featured.Note || '') + '</p>';
    ...
    if (items.length > 1) {
        ...
        for (var i = 1; i < items.length; i++) {
            ...
            html += '<div class="news-card-img"><img src="' + (item.ImageUrl || '') + '" alt="' + (item.Title || '') + '" loading="lazy"></div>';
            html += '<div class="news-card-body">';
            html += '<div class="news-card-tag">' + (item.CategoryName || '') + '</div>';
            html += '<div class="news-card-date">' + (item.Date || '') + '</div>';
            html += '<p class="news-card-text">' + (item.Note || '') + '</p>';
